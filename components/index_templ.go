...
func defaultHomeContent() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<h1 class=\"text-center\">Welcome &#128075; to my portfolio</h1><div class=\"flex flex-col items-center mt-4\"><img class=\"rounded-full w-100px h-100px\" src=\"/assets/images/profilePicture.jpg\" alt=\"Profile picture\"><p class=\"text-center max-w-lg mt-6\">Senior Software engineer with 7+ years of experience in high risk, fast paced startup environments. Proven track record of developing and deploying backend systems and applications with a focus on scalability, reliability, and performance.</p></div>")
...
func Index() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = Page("Masonictemple4Codes", nil).Render(templ.WithChildren(ctx, templ_7745c5c3_Var3), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
